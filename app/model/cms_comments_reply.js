...
module.exports = app => {
	...
	const CmsCommentsReply = app.model.define('cms_comments_reply', {
		...
		content: { type: DataTypes.TEXT, allowNull: false, comment: '回复内容' },
		comments_id: { type: DataTypes.INTEGER, allowNull: false, comment: '评论关联id' },
		member_uuid: { type: DataTypes.UUID, allowNull: false, comment: '用户关联uuid' },
