...
module.exports = app => {
	...
	const SysModelsFields = app.model.define('sys_models_fields', {
		...
		models_uuid: { type: DataTypes.UUID, allowNull: false, comment: '关联sys_models的uuid' },
		name: { type: DataTypes.STRING(50), allowNull: false, comment: '字段名' },
		comment: { type: DataTypes.STRING, allowNull: false, comment: '字段说明' },
