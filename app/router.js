...
module.exports = app => {
    ...
    router.post('/admin/modifiedPassword', app.middleware.sys.authAdminToken(), controller.sys.index.modifiedPassword);
    ...
    router.get(/^\/admin\/page\/(.*)$/, app.middleware.sys.authAdminToken(), controller.sys.index.page);
    ...
    router.post('/admin/sys/server/reloadCache/:type', app.middleware.sys.authAdminToken(), controller.sys.server.reloadCache);
