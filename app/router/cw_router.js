...
module.exports = app => {
	...
	app.router.get('附件列表', '/admin/cms/attachment/list', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.attachment.list');
	app.router.post('新增附件', '/admin/cms/attachment/add', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.attachment.add');
	app.router.post('删除附件', '/admin/cms/attachment/del', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.attachment.del');
	app.router.post('编辑附件', '/admin/cms/attachment/edit', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.attachment.edit');
	app.router.post('编辑附件上传', '/admin/cms/attachment/editUpload/:id', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.attachment.editUpload');
	app.router.post('文档快速编辑', '/admin/cms/doc/quickDocEdit', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.doc.quickDocEdit');
	...
	app.router.post('删除表单', '/admin/form/del', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'form.admin.del');
	app.router.get('表单前端页面', '/form/index', 'form.index.index');
	app.router.get('表单数据列表', '/admin/form/dataList/:form_id', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'form.admin.dataList');
	app.router.post('表单数据提交', '/form/submit', 'form.index.submit');
	app.router.get('表单个人提交数据列表', '/form/list', 'form.index.list');
	app.router.post('表单数据修改', '/admin/form/dataEdit', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'form.admin.dataEdit');
	app.router.post('表单数据删除', '/form/del', 'form.index.del');
	...
	app.router.post('发送短信验证码', '/mc/sendSms', 'mc.index.sendSms');
	app.router.post('更新手机号', '/mc/setup/upMobile', app.middleware.mc.authMcToken(), 'mc.setup.upMobile');
	app.router.get('激活邮箱', '/mc/setup/upEmailActiveLink', app.middleware.mc.authMcToken(), 'mc.setup.upEmailActiveLink');
	app.router.get('绑定微信', '/mc/setup/bindWechat', app.middleware.mc.authMcToken(), 'mc.setup.bindWechat');
	app.router.post('重置密码', '/mc/resetPassword', 'mc.index.resetPassword');
	app.router.get('图形验证码', '/mc/captcha', 'mc.index.captcha');
	app.router.post('手机短信登录', '/mc/loginByMobileCode', 'mc.index.loginByMobileCode');
	app.router.get('专题列表', '/admin/special/list', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'special.admin.list');
	app.router.get('专题首页', '/special.html', 'special.index.index');
	app.router.get('专题详情', '/special/:id', 'special.index.info');
	app.router.get('专题数据列表', '/admin/special/dataList/:special_id', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'special.admin.dataList');
	...
	app.router.post('导出表数据', '/admin/sys/models/exportData', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'sys.models.exportData');
	app.router.post('删除应用', '/admin/sys/application/del', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'sys.application.del');
	app.router.get('导出应用', '/admin/sys/application/export', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'sys.application.export');
	app.router.post('导入应用', '/admin/sys/application/import', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'sys.application.import');
	app.router.post('同步模型到数据库', '/admin/sys/models/sync', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'sys.models.sync');
	app.router.get('签到墙前端页面', '/wall/index', 'wall.index.index');
	app.router.post('签到', '/wall/sign', 'wall.index.sign');
	app.router.get('签到墙大屏页面', '/admin/wall/index', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'wall.admin.index');
	app.router.get('签到墙抽奖页面', '/admin/wall/lottery', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'wall.admin.lottery');
	app.router.post('签到墙抽奖', '/admin/wall/lottery', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'wall.admin.lotteryPost');
